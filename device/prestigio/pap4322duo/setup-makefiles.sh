...
echo "  $OUTDIR/proprietary/lib/hw/audio.primary.default.so:system/lib/hw/audio.primary.default.so \\" >> $MAKEFILE
echo "  $OUTDIR/proprietary/lib/hw/audio_policy.default.so:system/lib/hw/audio_policy.default.so" >> $MAKEFILE
